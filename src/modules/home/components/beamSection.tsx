...
export function AnimatedBeamMultipleOutputDemo({
  ...
  return (
    <div
      className={cn(
        "relative flex w-full items-center justify-center overflow-hidden pt-5 bg-background",
        className,
      )}
      ref={containerRef}
    >
      <div className="flex size-full flex-row items-stretch justify-between gap-10 max-w-lg">
        ...
        <div className="flex flex-col justify-center">
          <Circle ref={div6Ref} className="size-16">
            <Image src={"/logo.svg"} width={72} height={64} alt="logo" />
          </Circle>
        </div>
        <div className="flex flex-col justify-center">
          <Circle ref={div7Ref}>
    ...
    >
      <defs>
        ...
        >
          ...
          <stop offset="25%" stopColor="#2982ff" />
          <stop offset="40%" stopColor="#4e69ff" />
          <stop offset="60.1%" stopColor="#6559ff" />
          <stop offset="90.8%" stopColor="#6d53ff" />
        </radialGradient>
      </defs>
      <path
