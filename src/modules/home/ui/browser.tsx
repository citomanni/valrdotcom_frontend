...
type BrowserMode = "default" | "simple";
...
export function Browser({
  ...
  const openSite = () => {
    if (url.toLowerCase() == "digitaltrade.com") {
      setIsSiteOpen(true);
      setTimeout(() => setIsVideo(true), 3500);
    }
  };
  ...
  return (
    ...
    >
      ...
      {!isSiteOpen && (
        <foreignObject x="400" y="320" width="440" height="120">
          <h2 className="mb-6 text-5xl font-semibold">Google</h2>
          <div>
            <div className="flex items-center bg-gray-300 dark:bg-[rgb(44,44,44)] rounded-lg px-4 py-2 w-full h-full shadow-md">
              <input
                type="text"
                value={url}
                onChange={(e) => setUrl(e.target.value)}
                placeholder="Search with Google..."
                className="bg-transparent text-gray-700 dark:text-gray-200 text-xl placeholder-gray-500 outline-none w-full px-2"
              />
              <Search
      ...
      {!isVideo && isSiteOpen && (
        <foreignObject x="1" y="52" width="1200" height="700">
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 1 }}
          ...
          >
            <FlipText className="text-2xl font-bold -tracking-widest text-black dark:text-white">
              Launching DigitalTrade...
            </FlipText>
          </motion.div>
        </foreignObject>
      )}
